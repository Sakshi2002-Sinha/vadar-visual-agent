...
## Evaluation
[Auto-generated by eval/run_eval.py — paste eval/results.md here]

| # | Query | Category | Pass | Latency(ms) | Failure Reason |
|---|-------|----------|------|-------------|----------------|
| 1 | How many objects are in the scene? | counting | TBD | TBD | TBD |
| 2 | What is the name of the largest object? | comparison | TBD | TBD | TBD |
| 3 | Find all objects within 1 metre of the origin | proximity | TBD | TBD | TBD |
| 4 | Is there any object above height 2.0? | threshold | TBD | TBD | TBD |
| 5 | What is the closest object to position [1,0,1]? | proximity | TBD | TBD | TBD |
| 6 | Find all objects that are red | attribute | TBD | TBD | TBD |
| 7 | What is the average height of all objects? | aggregation | TBD | TBD | TBD |
| 8 | Are any two objects overlapping? | overlap | TBD | TBD | TBD |
| 9 | Find the object furthest from the origin | proximity | TBD | TBD | TBD |
| 10 | List objects sorted by distance to [0,0,0] | sorting | TBD | TBD | TBD |
| 11 | How many objects are taller than 1.5 units? | comparison | TBD | TBD | TBD |
| 12 | What colour is the object at position [2,0,2]? | attribute | TBD | TBD | TBD |
| 13 | Find all objects directly above the floor (y < 0.1) | containment | TBD | TBD | TBD |
| 14 | What is the total volume of all objects combined? | aggregation | TBD | TBD | TBD |
| 15 | Is the blue object to the left of the red object? | relative | TBD | TBD | TBD |
| 16 | Find objects that are not touching any other object | negation | TBD | TBD | TBD |
| 17 | What is the bounding box of the entire scene? | geometry | TBD | TBD | TBD |
| 18 | Find all pairs of objects within 0.5 metres of each other | proximity | TBD | TBD | TBD |
| 19 | Which object is most central in the scene? | comparison | TBD | TBD | TBD |
| 20 | Describe the spatial layout of the scene in one sentence | description | TBD | TBD | TBD |

**Overall accuracy: XX%  |  Avg latency: XXms  |  Failure rate: XX%**
